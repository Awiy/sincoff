            ...
            <div class="row">
              ...
              <div class="col-lg"> <!-- ada angka enam, u/ mencapai 12 pada col-lg-12 parentnya -->
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?= base_url('auth/resendverify') ?>">
                    ...
                    <button type="submit" class="btn btn-primary btn-toolbar btn-user btn-toolbar btn-outline-success m-auto">
                      Send activated code
                    </button>
                  </form>
                  <hr>
